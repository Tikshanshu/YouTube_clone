...
const ChannelCard = ({ channelDetail,marginTop }) => {
    return (
        <Box sx={{ boxShadow: 'none', borderRadius: '20px', height: '326px', margin: 'auto', justifyContent: 'center', alignItems: 'center', display: 'flex', width: { xs: '356px', md: '320px' },marginTop, }}>
